...
import { FileMusic, FileVideo, Image, Upload } from "lucide-react";
...
export function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[350px] w-full items-center justify-center overflow-hidden rounded-lg border-none bg-transparent p-10 shadow-xl md:shadow-xl",
        className,
      )}
      ref={containerRef}
    >
      <div className="flex size-full flex-row items-stretch justify-between gap-10 max-w-lg">
        <div className="flex flex-col justify-center gap-2">
          <Circle ref={div2Ref} className="bg-slate-200 hover:bg-slate-300">
            <Image />
          </Circle>
          <Circle ref={div3Ref} className="bg-slate-200 hover:bg-slate-300">
            <FileVideo />
          </Circle>
          <Circle ref={div4Ref} className="bg-slate-200 hover:bg-slate-300">
            <FileMusic />
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-16 bg-slate-200 hover:bg-slate-300">
            <Upload />
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle ref={div7Ref} className="bg-slate-200 hover:bg-slate-300">
            <Icons.user />
          </Circle>
        </div>
      </div>
